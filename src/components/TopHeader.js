    ...
    <div className="top-header">
      <div className="top-header__inner">
        <div className="top-header__left">
          ...
          <span className="top-header__location">123 Main St, City</span>
        </div>
        ...
        <div className="top-header__center">
          ...
          <span className="top-header__phone">
            ...
            <a className="top-header__link" href="tel:+1234567890">+1 (234) 567-890</a>
          </span>
        </div>
        ...
        <div className="top-header__right">
          ...
          <a className="top-header__link" href="mailto:you@example.com">you@example.com</a>
        </div>
      </div>
    </div>
  );
